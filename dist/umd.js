(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('eventsource-parser'), require('lodash')) :
    typeof define === 'function' && define.amd ? define(['exports', 'eventsource-parser', 'lodash'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OpenAIStreamParser = {}, global.eventsourceParser, global.lodash));
})(this, (function (exports, eventsourceParser, lodash) { 'use strict';
    ...
    ***************************************************************************** */
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            if (isValidJSON(str)) {
                                ...
                                if (!lodash.isEmpty(strParse.error)) {
                                    throw str;
                                }
                            }
                            parser.feed(str);
    ...
    exports.iterableStreamAsync = iterableStreamAsync;
